...
public class AnimationC {
    ...
    public boolean hasPosXAnim;
    public float[] timesPosX;
    public float[] valuePosX;

    private int curIndexPosY = 1;
    public boolean hasPosYAnim;
    public float[] timesPosY;
